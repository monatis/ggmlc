...
# 3. Offload autoregressive chat inference to NVIDIA CUDA GPU
./ggmlc-run smollm2_chat.gguf --chat "Explain quantum computing in one sentence." --device cuda --max-tokens 256
