...
struct ggml_tensor * ggml_conv_2d(
        ...
        int                   d0,
        int                   d1) {
    struct ggml_tensor * im2col = ggml_im2col(ctx, a, b, s0, s1, p0, p1, d0, d1, true, (a->type == GGML_TYPE_F32 || a->type == GGML_TYPE_BF16) ? GGML_TYPE_F32 : GGML_TYPE_F16); // [N, OH, OW, IC * KH * KW]
...
struct ggml_tensor * ggml_conv_2d_dw(
    ...
    struct ggml_tensor * im2col = ggml_im2col(ctx, new_a,
                                        ...
                                        s0, s1, p0, p1, d0, d1, true, (a->type == GGML_TYPE_F32 || a->type == GGML_TYPE_BF16) ? GGML_TYPE_F32 : GGML_TYPE_F16); // [N * IC, OH, OW, KH * KW]
