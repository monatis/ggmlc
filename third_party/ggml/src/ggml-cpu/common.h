...
template <>
struct type_conversion_table<int8_t> {
    static inline float to_f32(int8_t x) { return (float)x; }
    static inline int8_t from_f32(float x) { return (int8_t)x; }
};

template <>
struct type_conversion_table<int16_t> {
    static inline float to_f32(int16_t x) { return (float)x; }
    static inline int16_t from_f32(float x) { return (int16_t)x; }
};

template <>
struct type_conversion_table<int64_t> {
    static inline float to_f32(int64_t x) { return (float)x; }
    static inline int64_t from_f32(float x) { return (int64_t)x; }
};
